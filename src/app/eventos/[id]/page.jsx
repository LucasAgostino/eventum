...
export default function EventoDetalles({ params }){
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const { data, error } = await supabase
        .from('evento')
        .update({ nombreEvento, ubicacion, cantInvitados, fecha, presupuestoEstimado })
        .eq('id', params.id);
  ...
  return (
    <div>
      {editing ? (
        ...
        <h1 className="text-3xl font-bold mb-6 text-blue-600 border-b-2 border-blue-200 pb-4">Editar Evento</h1>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="nombreEvento">
              Nombre del Evento:
            </label>
            <input
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="cantidadInvitados">
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="presupuestoEstimado">
        ...
        <div>
          {event && (
            <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-8 mt-10">
              <h1 className="text-3xl font-bold mb-6 text-blue-600 border-b-2 border-blue-200 pb-4">Detalles del Evento</h1>
              ...
              <button class="mt-8 text-left flex gap-2 text-gray-600 hover:scale-110 duration-200 hover:cursor-pointer" onClick={handleEditar}>
                ...
                <span class="font-semibold text-sm text-green-700">Editar Evento</span>
              </button>
            </div>
          )}
        </div>
