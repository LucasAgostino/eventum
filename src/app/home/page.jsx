    ...
    <div className="bg-gradient-to-b from-black to-blue-900 min-h-screen">
      <div className="flex flex-col min-h-screen">
        ...
        <main className="">
              ...
              <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px] ">
                <div className="flex flex-col justify-center space-y-4 lg:col-start-1 ">
                  ...
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl">
                    ...
                    <p className="max-w-[600px] text-gray-500 md:text-xl ml-16">
                  ...
                  <div className="flex flex-col gap-2 min-[400px]:flex-row ml-16">
                    <a href="/login">
                    <button 
                      className="overflow-hidden relative w-32 p-2 h-12 opacity-50 text-white  rounded-md text-xl font-bold cursor-pointer relative z-10 group border"
                    >
                      Sign In
                      <span
                        className="absolute w-36 h-32 -top-8 -left-2 bg-blue-200 rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-500 duration-1000 origin-bottom"
                      ></span>
                      <span
                        className="absolute w-36 h-32 -top-8 -left-2 bg-blue-400 rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-700 duration-700 origin-bottom"
                      ></span>
                      <span
                        className="absolute w-36 h-32 -top-8 -left-2 bg-blue-600 rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-1000 duration-500 origin-bottom"
                      ></span>
                      <span
          ...
          <section className="w-full py-12 md:py-24 lg:py-32 screen  ">
            <div className="container grid items-center justify-center gap-4 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
              <div className="space-y-2">
                <h2 className="text-3xl text-white font-bold tracking-tighter md:text-4xl/tight ml-14">What our users say about Eventum</h2>
              ...
              <div className="grid gap-6">
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm shadow-2xl">
                  <div className="flex items-start space-x-4">
                    <span className="relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full">
                    <span className="flex h-full w-full items-center justify-center rounded-full bg-muted">
                      <img src='/circulo-de-usuario.png' alt=''></img>
            ...
            <div className='w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b to-black opacity-50 z-0 '>
              <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6 relative z-10 ">
                ...
                <div className="mx-auto w-full max-w-sm space-y-2 ">
                  <a href="/register">
                  <button
                      className="overflow-hidden relative w-32 p-2 h-12 bg-black text-white  rounded-md text-l font-bold cursor-pointer relative z-10 group border"
                    >
                      Sign Up
                      <span
                        className="absolute w-36 h-32 -top-8 -left-2 bg-blue-200 rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform group-hover:duration-500 duration-1000 origin-bottom"
                      ...
                      ></span>
                      <span
                        className="group-hover:opacity-100 group-hover:duration-1000 duration-100 opacity-0 absolute top-3 left-8 z-10 text-white"
                        >Sign Up</span>
                    </button>
                  </a>
                </div>
