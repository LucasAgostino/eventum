        ...
        <div className="bg-white border border-gray-300 shadow-lg p-4 max-h-full rounded-lg mr-4 mb-4 sm:ml-4 w-full max-w-lg" style= {{height:298}}>
          ...
          {proximoEvento ? (
            <div className="flex items-center mb-4">
              <div>
                <h2 className="text-3xl font-semibold mb-2 lg:mt-5 sm:mt:2">
                  <strong>{proximoEvento.nombreEvento}</strong>
                </h2>
                <p className="text-gray-600 text-sm mb-2 lg:mt-5 sm:mt-0">
                  <strong> Fecha: </strong>
          ...
          <div>
            <div className="flex flex-col sm:flex-row items-start sm:items-center mt-1">
              ...
              <div className="sm:ml-4">
                <p className="text-sm text-gray-600 bg-gray-200 border rounded-3xl p-2 rounded-sm">
                  {invitacionEnviada ? "🟢 Enviadas" : "⚪ No enviadas"}
                </p>
              </div>
            </div>
            <div className="text-sm text-gray-600 mt-3">
              <div className="inline-block bg-gray-200 p-2 rounded-full">
